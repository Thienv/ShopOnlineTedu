        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CustomerAddres = c.String(nullable: false, maxLength: 256),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Names = c.String(nullable: false, maxLength: 256),
                        Alias = c.String(nullable: false, maxLength: 256),
                        CategoryID = c.Int(nullable: false),
                        Images = c.String(nullable: false, maxLength: 256),
                ...
                c => new
                    {
                        ...
                        Names = c.String(nullable: false, maxLength: 256),
                        Alias = c.String(nullable: false, maxLength: 256),
                        Descriptions = c.String(nullable: false, maxLength: 256),
                        ParentID = c.Int(),
                        DisplayOrder = c.Int(),
                        Images = c.String(nullable: false, maxLength: 256),
                        HomeFlag = c.Boolean(),
                ...
                c => new
                    {
                        ...
                        CategoryID = c.Int(nullable: false),
                        Images = c.String(nullable: false, maxLength: 256),
                        Descriptions = c.String(nullable: false, maxLength: 500),
                        Content = c.String(),
                        HomeFlag = c.Boolean(),
                        HotFlag = c.Boolean(),
                        ViewCount = c.Int(),
                ...
                c => new
                    {
                        ...
                        Descriptions = c.String(nullable: false, maxLength: 256),
                        Images = c.String(nullable: false, maxLength: 256),
                        Urls = c.String(nullable: false, maxLength: 256),
                        DisplayOrder = c.Int(),
                        Statuss = c.Boolean(),
                    })
                .PrimaryKey(t => t.ID);
